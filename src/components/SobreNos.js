...
function App() {
  return (
    <div className="about">
      ...
      <br />
      <br />
      <p>No dia 1º de fevereiro, nos foi dado um desafio: o que pode ser feito, em apenas um final de semana, com nossas habilidades e tempo, para mitigar os impactos das chuvas que recentemente pôs em risco a vida de muitos e foram fatais para outros.
...
Graças à nossa união e à orientação da equipe da Trybe, conseguimos transfomar essa ideia em realidade.</p>
      ...
      <li className="trybers-list">
        <ul className="tryber"><a className="trybe-name" href="https://www.linkedin.com/in/albertosca/"><img src="https://media-exp1.licdn.com/dms/image/C4E03AQExyuv0PydqbQ/profile-displayphoto-shrink_800_800/0?e=1586390400&v=beta&t=DkCdRx39SgokOk-q2pUdoGuRr1cwddGnylig9Ja4CUI" alt="Alberto Albuquerque pic" /><br />Alberto Albuquerque</a></ul>
        ...
        <ul className="tryber"><a className="trybe-name" href="https://www.linkedin.com/in/lucas-cassiano-ferraz-paolillo/"><img src="https://media-exp1.licdn.com/dms/image/C4E03AQG83cY-t41h1g/profile-displayphoto-shrink_800_800/0?e=1586390400&v=beta&t=QYjSel2orYbwtyeJz8Q4ZqUGt-XdLOaXTPDYSFZYqsc" alt="Lucas Ferraz pic" /><br />Lucas Ferraz</a></ul>
