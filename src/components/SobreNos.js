...
Graças à nossa união e à orientação da equipe da Trybe, conseguimos transfomar essa ideia em realidade.</p>
      ...
      <li className="trybers-list">
        ...
        <ul className="tryber"><a className="tryber" href="https://www.linkedin.com/in/anacmquintao/"><img className="trybersImg" src="https://media-exp1.licdn.com/dms/image/C4E03AQGt_0jjV4vM0g/profile-displayphoto-shrink_200_200/0?e=1590624000&v=beta&t=bbxIn4LpFv18bwjxD1tR7GyD9a1IC8LUliiPIodU0ys" alt="Ana Quintão" /><br />Ana Quintão</a></ul>
        ...
        <ul className="tryber"><a className="tryber" href="https://www.linkedin.com/in/marcosmoura1/"><img className="trybersImg" src="https://media-exp1.licdn.com/dms/image/C4D03AQExBi5YPlqsJg/profile-displayphoto-shrink_200_200/0?e=1590624000&v=beta&t=_WdXznPQ1NpaSuCnDDOLtY-V0KqfwvDQsXH4YOD9hgw" alt="Marcos Moura" /><br />Marcos Moura</a></ul>
