  ...
  render() {
    return (
      <div>
        ...
        <iframe title="wazeMbeded" className='waze-API' src="https://embed.waze.com/pt-BR/iframe?&zoom=15&lat=-19.953266&lon=-44.013061&pin=1" width="350" height="350"></iframe>
